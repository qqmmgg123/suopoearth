...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root) {
	    var popup = __webpack_require__(1),
	        Cropper = __webpack_require__(3),
	        cropTpl = __webpack_require__(13),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	(function (factory) {
	    var keyboard = __webpack_require__(2);
	    ...
	    Popup.prototype = {
	            ...
	            for (var o in this.defaultOpts) {
	                switch (o.toLowerCase()) {
	                    ...
	                    case 'top':
	                        ...
	                        break;
	                    case 'arrow':
	                        if (typeof opts[o] != "boolean") opts[o] = this.defaultOpts[o];
	        ...
	        bintEvents: function bintEvents() {
	            var self = this;
	            function handle() {
	                self.close();
	        ...
	        show: function show() {
	            ...
	            this.defaultOpts.left = (win_width - this.width) * 0.5, this.defaultOpts.top = (win_height - this.height) * 0.5, this.setOpts(this.settings);
	            this.bintEvents();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (factory) {
	    ...
	    Keyboard.prototype = {
	        ...
	        getKeyName: function getKeyName(key_code, key_type) {
	            var key_name = '';
	        ...
	        getKeyEvent: function getKeyEvent(key_name, key_type) {
	            // 查找并触发单键
	        ...
	        addHandle: function addHandle(evt, callback) {
	            var name = evt;
	        ...
	        removeHandle: function removeHandle(evt, callback) {
...
/***/ function(module, exports) {
	...
	var __t, __p = '';
	with (obj) {
	__p += '<img id="image-preview" src="/images/avatar.png" />\r\n<button class="btn" type="button">裁好了</button>\r\n';
